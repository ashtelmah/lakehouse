Lakehouse Platform
Unified Streaming + Iceberg Architecture Author: ashtelmah
...
Flink SQL Gateway
REST SQL endpoint: 8087 Executes Iceberg SQL

Automatically initializes catalogs, tables, functions
Init Runner - Runs SQL scripts on startup
